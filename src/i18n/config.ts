...
const resources = {
  ...
  logout: 'लॉगआउट'
      ...
      home: {
        ...
        notice: "महत्वपूर्ण सूचना: कृपया 25 जून को शाम 5:00 बजे ग्राम सभा की बैठक में उपस्थित रहें। आपकी भागीदारी गाँव के विकास के लिए मूल्यवान है!",
        welcomeTitle: "जानोरी ग्राम पंचायत में आपका स्वागत है",
        welcomeText1: "जानोरी महाराष्ट्र के बुलढाणा जिले का एक छोटा लेकिन धार्मिक और ऐतिहासिक रूप से समृद्ध गाँव है। यह गाँव शेगाँव से कुछ ही किलोमीटर की दूरी पर स्थित है। यह स्थान विदर्भ क्षेत्र में विशेष रूप से प्रसिद्ध है, क्योंकि यहाँ कई प्राचीन मंदिर और धार्मिक परंपराएं हैं।",
        welcomeText2: "हमारे सरपंच और समर्पित पंचायत सदस्यों के दूरदर्शी नेतृत्व में, हम अपनी समृद्ध सांस्कृतिक विरासत को संरक्षित करते हुए जानोरी को आधुनिक सुविधाओं वाले एक आदर्श गाँव में बदलने के लिए अथक प्रयास कर रहे हैं।",
        learnMore: "हमारे बारे में और जानें",
        membersTitle: "हमारे ग्राम पंचायत सदस्य",
        membersSubtitle: "गाँव के विकास के लिए समर्पित नेतृत्व",
        memberTable: {
          sr: "क्र.सं.",
          photo: "चित्र",
          name: "नाम",
        ...
        membersList: [
          { name: 'सौ. लता धोंडूराम घेंगे', position: 'सरपंच', category: 'ना.मा.प्र.' },
          { name: 'श्री. नंदकिशोर गणेश गावंडे', position: 'उपसरपंच', category: 'सामान्य' },
          { name: 'श्री. रमेश जयराम डांगे', position: 'सदस्य', category: 'अ.जा.' },
          { name: 'श्री. शंकर रामदास सोळंके', position: 'सदस्य', category: 'अ.जा.' },
          { name: 'सौ. दिक्षा गजानन भोजने', position: 'सदस्या', category: 'स.सा.स्त्री' },
          { name: 'सौ. सुरेखा सुधाकर घेंगे', position: 'सदस्या', category: 'स.सा.स्त्री' },
          { name: 'सौ. दुर्गा प्रभाकर बोरसे', position: 'सदस्या', category: 'स.सा.स्त्री' },
          { name: 'सौ. अर्चना मंगेश ढोले', position: 'सदस्या', category: 'ना.मा.प्र.' },
          { name: 'शेख रेहाना शेख मोहसीन', position: 'सदस्या', category: 'स.सा.स्त्री' },
          { name: 'श्री. डि. के. बाजोले', position: 'सचिव', category: '-' },
  ...
  logout: 'लॉगआउट'
      ...
      home: {
        ...
        notice: "महत्वाची सूचना: कृपया २५ जून रोजी सायंकाळी ५:०० वाजता ग्रामपंचायत हॉलमध्ये होणाऱ्या ग्रामसभेला उपस्थित राहा. तुमचा सहभाग गावाच्या विकासासाठी मोलाचा आहे!",
        welcomeTitle: "जानोरी ग्रामपंचायतीत आपले स्वागत आहे",
        welcomeText1: "जानोरी हे महाराष्ट्रातील बुलढाणा जिल्ह्यातील एक छोटे पण धार्मिक आणि ऐतिहासिकदृष्ट्या समृद्ध गाव आहे. हे गाव शेगावपासून अवघ्या काही किलोमीटर अंतरावर आहे. विदर्भ क्षेत्रात या गावाला विशेष महत्त्व आहे, कारण येथे अनेक प्राचीन मंदिरे आणि धार्मिक परंपरा जोपासल्या जातात.",
        welcomeText2: "आमच्या सरपंचांच्या आणि समर्पित पंचायत सदस्यांच्या दूरदर्शी नेतृत्वाखाली, आम्ही जानोरीचा सांस्कृतिक वारसा जपत गावाला आधुनिक सुविधांनी युक्त अशा आदर्श गावात बदलण्यासाठी अहोरात्र प्रयत्न करत आहोत.",
        ...
        membersList: [
          { name: 'सौ. लता धोंडूराम घेंगे', position: 'सरपंच', category: 'ना.मा.प्र.' },
          { name: 'श्री. नंदकिशोर गणेश गावंडे', position: 'उपसरपंच', category: 'सर्वसाधारण' },
          { name: 'श्री. रमेश जयराम डांगे', position: 'सदस्य', category: 'अ.जा.' },
          { name: 'श्री. शंकर रामदास सोळंके', position: 'सदस्य', category: 'अ.जा.' },
          { name: 'सौ. दिक्षा गजानन भोजने', position: 'सदस्या', category: 'स.सा.स्त्री' },
          { name: 'सौ. सुरेखा सुधाकर घेंगे', position: 'सदस्या', category: 'स.सा.स्त्री' },
